...
rectangle.addEventListener('click', ()=>{
    if(rectangle.classList.contains('tab-active') == false){
        ...
        block[0].classList.add('cost__type_block-active');
        circle.classList.remove('tab-active');
        rectangle.classList.add('tab-active');
        document.querySelector('.cost__wrapper').classList.remove('cost__wrapper_active');
    }
});
...
circle.addEventListener('click', ()=>{
    if(circle.classList.contains('tab-active') == false){
        ...
        block[2].classList.add('cost__type_block-active');
        console.log(document.querySelector('.two').checked);
        rectangle.classList.remove('tab-active');
        circle.classList.add('tab-active');

        document.querySelector('.cost__wrapper').classList.add('cost__wrapper_active');
    }
});
...
document.querySelector('.width').addEventListener('input', () => {
    ...
    if(a > 140) validValueRange = false,
                ...
                document.querySelector('.cost__wrapper').classList.add('cost__wrapper_active-height'),
            ...
            document.querySelector('.cost__wrapper').classList.remove('cost__wrapper_active-height');
...
document.querySelector('.diameter').addEventListener('input', () => {
    ...
    if(a > 140) validValueRange = false,
        ...
        document.querySelector('.circle_value1_2').innerHTML = `${discountPrice1_2}&nbsp`;
        document.querySelector('.circle_value2').innerHTML = `${discountPrice2}&nbsp`;
    }
});
